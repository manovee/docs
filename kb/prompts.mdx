...
Use **Add Topic** when you want to group related prompts. Topics make the prompt list easier to scan and help teams separate workflows by product, funnel stage, market, or use case.
...
- Active prompts can be tested against AI models.
- Prompt topics make long lists easier to manage.
- Suggested prompts are based on company context such as name, website, industry, and location.
- Prompt limits depend on the workspace plan.
- Deactivated prompts stop new monitoring while keeping past results available.

Review prompts regularly so your workspace keeps tracking the questions customers actually ask.
